...
body
{
background-image = url("C:\Users\M Atif\Desktop\lap.jpg");
background-repeat = no-repeat; 
    ...
    <body>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-top">
			                    <form role="form" action="submit.php" method="post" class="login-form">
                                ...
                                <div class="form-group">
                                        <label class="sr-only" for="form-password">Password</label>
                                        <input type="text" name="email" placeholder="Email" class="form-password form-control"">
                                    </div>
